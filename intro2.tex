...
% Second: general learning
\revised{The second goal is to develop a set of general computational tools for
...
% Third: export
\revised{The final goal is to design a new algorithm that helps us deploy a
