...
values for robotic technologies, \revised{such as search and rescue people.}
%%  such as rescuing individual people and reclaiming locations hit by
%% disasters with robots.
%%%% https://en.wikipedia.org/wiki/Fukushima_Daiichi_nuclear_disaster
\revised{When the Fukushima Daiichi nuclear meltdown occurred in 2011, which}
%% When there was a nuclear meltdown that 
was too dangerous to be recovered
by human due to high radiation levels, a few robots were \revised{deployed} to
...
\revised{One great example that showcases a suite of agile motions is Parkour,
  ...
  The skills of Parkour is well aligned with our definition of agile motions
  because it requires high momentum and dynamic planning to negotiate with the
...
\revised{The first issue is to ensure the safty of humanoids.
...
of agile motions \revised{instead of manually designing all controllers
  individually.} 
% Third: export
