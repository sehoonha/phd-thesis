...
The robots would have achieved the assigned tasks if they had \revised{had}
enough agility
...
%% Version 1.2
\revised{We discuss two different falling controllers for virtual and real
  humanoids. 
...
%% Version 1.3
\revised{Our goal is to design an intuitive and efficient learning framework
  ...
  we develop a novel interactive interface that designs controllers using only
...
\revised{During the coaching stage, the user provides instructions for revising
...
\revised{highly constrained problems, which are formulated when the user
