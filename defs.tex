...
\newcommand{\revtwost}[1]{}
\newcommand{\revthree}[1]{\textcolor{red}{#1}}
...
\newcommand{\lineref}[1]{Line~\ref{alg:line:#1}}
\newcommand{\linealgref}[2]{Line~\ref{alg:line:#1}~in~Alg.~\ref{alg:#2}}
